 ...
 *
 * @version 0.2 (from 0.1 by Simeon Lyubenov <office@webdevlabs.com>)
 */
    ...
    private function run()
    {
        while (true) {
                ...
                // client socket has sent data
                    ...
                    // there is data to be read
                        ...
                        // handshake already done, read data
                            ...
                            elseif (substr($action, 0, 7) == 'system:') {
                                $skipSockets = [$this->master, $socket];
                                $them = array_diff($this->allsockets, $skipSockets);
                                $output = [];
                                $output['system'] = substr($action, 7);
            ...
            if ($timeDiff > 1000) {//send messages out every 1000 ms
                ...
                $destinSockets = array_diff($this->allsockets, [$this->master]);
